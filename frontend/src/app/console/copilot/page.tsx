              ...
              >
                ...
                <div className="space-y-sm min-w-0 flex-1">
                  ...
                  >
                    ...
                    <span>•</span>
                    <span>{isUser ? "Dayamay Das" : "InsightForge AI Core"}</span>
                  </div>
                </div>
              </div>
            );
        ...
        <div className="mt-md border-t border-white/5 pt-md relative z-10">
          ...
          >
            ...
            <input
              ...
              placeholder="Ask InsightForge AI anything..."
          ...
          <p className="text-center text-[9px] font-semibold text-outline mt-sm select-none">
            InsightForge AI Copilot is operating under secure enterprise SLA compliance sandbox guidelines.
          </p>
        </div>
